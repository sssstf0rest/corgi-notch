...
//  CorgiNotch
//
//  Created by Monu Kumar on 3/11/25.
//
...
NSString *AudioOutputVolumeNotification = @"AudioOutputVolume";
NSString *AudioOutputDeviceNotification = @"AudioOutputDevice";
...
{
    static AudioOutput *instance = 0;
    if (0 == instance)
        instance = [[AudioOutput alloc] init];
    return instance;
}
...
- (id)init
{
    ...
    _selector = kAudioHardwarePropertyDefaultOutputDevice;
    _scope = kAudioDevicePropertyScopeOutput;
...
- (void)systemObjectPropertyDidChange
{
    ...
    [[NSNotificationCenter defaultCenter]
     postNotificationName:AudioOutputDeviceNotification
     object:self
     userInfo: nil
    ];
}
...
{
    [[NSNotificationCenter defaultCenter]
     postNotificationName:AudioOutputVolumeNotification
     object:self
     userInfo:nil
    ];
}
